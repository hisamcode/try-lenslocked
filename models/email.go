...
type EmailService struct {
	// Default sender is used as the default sender when one isn't provided for an
...
func (es *EmailService) ForgotPassword(to string, resetURL string) error {
	email := Email{
		...
		HTML:      fmt.Sprintf(`<p>To reset your password, please visit the following link <a href="%s">%s</a>`, resetURL, resetURL),
	}
