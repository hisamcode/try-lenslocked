...
import (
	...
	"github.com/hisamcode/lenslocked/rand"
)
...
func (service *PasswordResetService) Create(email string) (*PasswordReset, error) {
	// verify we have a valid email address for a user, and get that the user id
	...
	err := row.Scan(&userID)
	if err != nil {
		// TODO: consider returning a spesific error when the user does not exist.
